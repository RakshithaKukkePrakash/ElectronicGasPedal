...
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000758u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480007ECu)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480007F4u)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x480007FCu)
