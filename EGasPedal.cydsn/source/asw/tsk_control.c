 ...
 *
 * description: Task for control calculation and brake
 * events: ev_joystick_onData|ev_speed_onData
 * mode: Event
 * name: tsk_control
 * shortname: control
 * signalpoolsRO: 
...
const RTE_eventTable_t RTE_eventActivationTable_tsk_control[] = {
    { CONTROL_calcControl_run, ev_joystick_onData },  //Runnable for joystick
...
TASK(tsk_control)
{
    ...
    while(1)
    {
        ...
        WaitEvent(ev_joystick_onData|ev_speed_onData);
