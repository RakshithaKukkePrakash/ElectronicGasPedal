...
RC_t JOYSTICK_ReadPosition(sint8_t* x, sint8_t* y)
{
    ...
    Joystick_ADC_IsEndConversion(Joystick_ADC_WAIT_FOR_RESULT);

    //Read channels
    uint16_t posX = Joystick_ADC_GetResult16(0);
    uint16_t posY = Joystick_ADC_GetResult16(1);
